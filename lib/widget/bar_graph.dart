...
class BarChartSample2 extends StatefulWidget {
  ...
  final Color leftBarColor = const Color.fromRGBO(30, 203, 225, 1);
  final Color rightBarColor = const Color.fromRGBO(225, 52, 30, 1);
  final Color avgColor = const Color.fromRGBO(79, 129, 135, 1);
  @override
...
class BarChartSample2State extends State<BarChartSample2> {
  ...
  Widget bottomTitles(double value, TitleMeta meta) {
    ...
    final Widget text = Text(
      titles[value.toInt()],
      style: TextStyle(
        color: Theme.of(context).colorScheme.surfaceTint.withOpacity(.85),
        fontWeight: FontWeight.w500,
        fontSize: 14,
      ),
    );
